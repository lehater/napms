...
function Fact({ label, value }: { label: string; value: string }) { return <div className="rounded-[var(--napms-control-radius)] bg-[var(--napms-color-surface-subtle)] px-3 py-2"><div className="text-[11px] font-semibold uppercase tracking-wide text-[var(--napms-color-text-secondary)]">{label}</div><div className="text-sm font-semibold text-[var(--napms-color-text-primary)]">{value}</div></div> }
