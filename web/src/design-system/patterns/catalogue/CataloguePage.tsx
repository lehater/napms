...
export function CatalogueSurface({ children, className = "" }: { children: React.ReactNode; className?: string }) {
...
export function CatalogueFilterField({ label, className = "", children }: { label: React.ReactNode; className?: string; children: React.ReactNode }) {
...
export function CatalogueViewBar({ children, actions }: { children: React.ReactNode; actions?: React.ReactNode }) {
...
export function CataloguePaginationControls({ page, pageSize, total, onPageChange, onPageSizeChange, pageSizeOptions = [25, 50, 100], disabled = false }: { page: number; pageSize: number; total: number; onPageChange: (page: number) => void; onPageSizeChange: (pageSize: number) => void; pageSizeOptions?: number[]; disabled?: boolean }) {
