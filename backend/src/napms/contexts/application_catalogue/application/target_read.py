...
from napms.contexts.application_catalogue.domain.communication import AuthoredDcsTrafficAlternative
from napms.contexts.application_catalogue.domain.model import Application, CatalogueInvariantError, Component
