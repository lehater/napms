...
from napms.application_catalogue.application.dcs_curation import CreateDcsRevisionCommand
from napms.application_catalogue.application.deployment_curation import (
    CreateComponentDeploymentCommand,
)
from napms.application_catalogue.application.structure_curation import CreateComponentCommand
