...
| Application/Component/Deployment/DCS structure | Application Communication Catalogue | catalogue source through owned model/adapter | proposal, export | stable identity/version; DCS revision provenance | proposal requires exact structural validity; export requires as-of-valid facts where temporal |
| Resource/Endpoint technical realization | Resource Catalogue | resource catalogue source through owned model/adapter | export | realization identity/version/effective validity/source | must be provably valid for export as-of |
