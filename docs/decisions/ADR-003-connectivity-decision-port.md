...
ADR-005 promotes Connectivity Decision to a first-class Bounded Context with accepted decision identity, governance scope, validity, reason/provenance, Authority actions and supersession semantics.
