...
- required domain and architecture owners, plus any applicable interface/integration and persistence owners, are current in `docs/canonical-graph.yaml`.
...
5. Implement inside-out: Domain -> Application/Use Cases + Ports -> executable proof -> applicable inbound/outbound adapters + composition.
